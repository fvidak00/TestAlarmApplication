...
using TestAlarmApplication.BroadCast;
using Android.Support.V7.App;

namespace TestAlarmApplication
{
    [Activity(Label = "TestAlarmApplication", MainLauncher = true, Icon = "@drawable/icon", Theme = "@style/Theme.AppCompat.Light.NoActionBar")]
